// src/components/TeamAndOpportunity.tsx
import {
  TrendingUp,
  ShieldCheck,
  Zap,
  ...
  const userBenefits = [
    {
      ...
      value: "Zero Friction",
      description:
        "Direct ecosystem data bridges remove manual procurement complexities and market fragmentation.",
    ...
    },
    {
      ...
      value: "Audit-Ready",
      description:
        "Full visibility from origin to retirement ensures infrastructure compliance with ESG and SDG standards.",
    ...
    },
    {
      ...
      value: "USD 4.73T",
      description:
        "Strategically position your portfolio via Atlas in a market scaling to $4.73T by 2030.",
        ...
        <div className="w-full max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left gap-6">
            ...
            <p className="text-gray-500 font-medium text-base md:text-lg lg:text-xl leading-relaxed max-w-lg">
              Move beyond fragmented systems. troo.earth provides the governance
              and technology architecture required for global organizations to
              deploy climate capital with measurable impact.
            </p>
            ...
            <div className="mt-4 p-6 border-l-4 border-accent bg-accent/5 rounded-r-2xl max-w-md lg:max-w-lg">
              <p className="text-secondary font-bold text-sm md:text-base leading-relaxed">
                "Our infrastructure enables a transparent, reliable approach to
                environmental asset management that stands up to global scrutiny."
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12 max-w-5xl">
            ...
            <div className="max-w-md xl:self-end lg:mb-2">
              <p className="text-gray-500 font-medium text-lg lg:text-xl leading-relaxed lg:border-l-0 border-l-2 border-primary/20 lg:pl-0 pl-4">
                Built by technologists and climate experts dedicated to scaling
                the next generation of climate-tech infrastructure.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                <div className="space-y-4 p-8 rounded-[2rem] bg-white/20 border border-white/40 backdrop-blur-sm">
                  ...
                  <p className="text-gray-500 font-medium leading-relaxed italic text-lg">
                    "Born from a passion for climate action, we've engineered
                    an ecosystem that removes friction and standardizes integrity 
                    across the board."
                  </p>
                </div>
                ...
                <div className="space-y-4 p-8 rounded-[2rem] bg-primary text-white shadow-2xl relative overflow-hidden">
                  ...
                  <p className="text-white/80 font-medium leading-relaxed text-lg relative z-10">
                    A climate-tech engine built to drive efficiency into the
                    global ecosystem, empowering enterprises to manage
                    portfolios on Atlas with absolute confidence.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 p-8 md:p-10 rounded-[2.5rem] border border-secondary/5 bg-white/10 mt-auto">
                <div>
                  ...
                  <p className="text-gray-500 text-sm font-medium">
                    Explore the values and purpose driving our ecosystem forward.
                  </p>
                </div>
                <Link
                  to="/vision-mission"
